      ...
      {selectedChat ? (
        <>
          ...
          >
            ...
            {(isTyping)?(<div>
              <lottie-player src="https://lottie.host/0dcc5be7-9f6a-4226-b918-5aed19d4ff13/sOC5a0Z4Qr.json" background="##FFFFFF" speed="1" style={{width:"30%",height:"20%"}} loop autoplay></lottie-player>
            </div>):(<></>)}
              <Input
                variant="filled"
                bg="white"
